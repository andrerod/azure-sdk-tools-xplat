...
exports.init = function (cli) {
  ...
  storage.command('update <name>')
    ...
    .execute(function (name, options, callback) {
      ...
      utils.doServiceManagementOperation(channel, 'updateStorageAccount', name, storageOptions, function (error) {
        progress.end();
  ...
  storage.command('delete <name>')
    ...
    .execute(function (name, options, callback) {
      ...
      utils.doServiceManagementOperation(channel, 'deleteStorageAccount', name, function (error) {
        progress.end();
  ...
  function logEachData(title, data) {
    ...
    Object.keys(cleaned).forEach(function (property) {
