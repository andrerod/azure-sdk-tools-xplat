...
exports.init = function (cli) {
  ...
  siteDomain.command('add')
    ...
    .argument('-d, --domain <domain>', { required: true, position: 0, prompt: 'Domain: ', description: 'the new domain' })
    .argument('[name]', { required: false, position: 1, description: 'the new domain' })
    .argument('-s, --subscription <id>', { required: false, description: 'use the subscription id' })
