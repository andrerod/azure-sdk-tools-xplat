...
exports.init = function (cli) {
  ...
  function getPublishingUser(context, _) {
    ...
    if (!administrators.some(function (administrator) {
      return utils.ignoreCaseEquals(administrator, username);
    })) {
  ...
  site.doSitesPost = function (options, callback) {
    ...
    site.Site.HostNames = {
      'a:string': [ site.Site.name + utils.getHostNameSuffix() ]
    };
  ...
  /*jshint unused:false*/
  site.doLocationsGet = function (options, _) {
    return [
