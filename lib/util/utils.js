...
exports.createServiceManagementService = function(subscriptionId, account, logger) {
  ...
  var serviceManagementService = azure.createServiceManagementService(subscriptionId, {
    keyvalue: pem.key,
    certvalue: pem.cert
  }, {
  ...
  serviceManagementService.userAgent = getUserAgent();
...
exports.createServiceBusManagementService = function(subscriptionId, account, logger) {
  var pem = account.managementCertificate();
  var managementEndpoint = url.parse(exports.getManagementEndpointUrl(account.managementEndpointUrl()));
  var serviceBusManagementService = azure.createServiceBusManagementService(subscriptionId, {
    keyvalue: pem.key,
    certvalue: pem.cert
  }, {
    host: managementEndpoint.hostname,
  ...
  serviceBusManagementService.userAgent = getUserAgent();
  return serviceBusManagementService;
};
