...
exports.createSqlManagementService = function(subscription, logger) {
  return createService('createSqlManagementService', subscription, logger);
};

exports.createServiceBusManagementService = function(subscription, logger) {
  return createService('createServiceBusManagementService', subscription, logger);
};
...
exports._createWebsiteManagementService = function(subscription, logger) {
  var service = azure._createWebsiteManagementService({
...
exports.createScmManagementService = function(repository, auth, logger) {
